(function($){
	...
	*/
	...
	$.fn.simplemusic=function(settings){
	    $(this).css({ "z-index": "999", "width": "44px", "height": "44px", "position": "fixed", "bottom": "10px", "right": "10px", "cursor": "pointer", "background": "url(../mosquito-blog-html//images/bgmusic.png)" }).bind("click", function () {
			if(_playstatus){
				pause(this);
			}else{
				play(this);
